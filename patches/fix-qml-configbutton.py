#!/usr/bin/env python3
"""Replace inline KeySequenceItems with a Configure button that opens Shortcuts KCM pre-filtered to KWin."""
...
if old not in content:
    ...
    with open(filepath, 'w') as f:
        f.write(content)
    print('Replaced inline shortcuts with Configure button (pre-filtered to kwin)')
